...
import com.dental_clinic.dental_service.Config.ScheduledTasks;
...
public class DentalServiceApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext applicationContext = SpringApplication.run(DentalServiceApplication.class, args);
