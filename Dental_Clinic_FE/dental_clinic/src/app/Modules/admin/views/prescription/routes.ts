...
const defaultUrl = ROUTES.ADMIN.children.PRESCRIPTION.children.LIST.path;
...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            {
                path: ROUTES.ADMIN.children.PRESCRIPTION.children.LIST.path,
                loadComponent: () =>
            ...
            {
                path: ROUTES.ADMIN.children.PRESCRIPTION.children.CREATE.path,
                data: {
                    title: 'Create',
                },
            ...
            {
                path: ROUTES.ADMIN.children.PRESCRIPTION.children.EDIT.path,
                data: {
                    title: 'Edit',
                },
            ...
            {
                path: ROUTES.ADMIN.children.PRESCRIPTION.children.DETAIL.path,
                data: {
                    title: 'Detail',
                },
