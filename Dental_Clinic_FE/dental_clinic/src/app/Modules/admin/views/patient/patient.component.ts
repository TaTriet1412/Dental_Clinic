...
export class PatientComponent implements OnInit, OnDestroy {
  ...
  goToCreatePatient() {
    this.router.navigate([ROUTES.ADMIN.children.PATIENT.children.CREATE.fullPath]);
  }
  ...
  goToEditPatient(id: string) {
    this.router.navigate([ROUTES.ADMIN.children.PATIENT.children.EDIT.fullPath(id)]);
  }
}