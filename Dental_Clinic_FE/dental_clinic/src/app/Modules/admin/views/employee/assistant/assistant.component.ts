...
export class AssistantComponent implements OnInit, OnDestroy {
  ...
  goToCreateAssistant() {
    this.router.navigate([ROUTES.ADMIN.children.EMPLOYEE.children.ASSISTANT.children.CREATE.fullPath]);
  }
  ...
  goToEditAssistant(id: string) {
    this.router.navigate([ROUTES.ADMIN.children.EMPLOYEE.children.ASSISTANT.children.EDIT.fullPath(id)]);
  }
