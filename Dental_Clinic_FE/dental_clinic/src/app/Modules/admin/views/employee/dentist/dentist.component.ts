...
export class DentistComponent implements OnInit, OnDestroy {
  ...
  goToCreateDentist() {
    this.router.navigate([ROUTES.ADMIN.children.EMPLOYEE.children.DENTIST.children.CREATE.fullPath]);
  }
  ...
  goToEditDentist(id: string) {
    this.router.navigate([ROUTES.ADMIN.children.EMPLOYEE.children.DENTIST.children.EDIT.fullPath(id)]);
  }
