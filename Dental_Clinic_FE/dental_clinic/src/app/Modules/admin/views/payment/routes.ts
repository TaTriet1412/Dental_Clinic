...
const defaultUrl = ROUTES.ADMIN.children.PAYMENT.children.LIST.path;
...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            {
                path: ROUTES.ADMIN.children.PAYMENT.children.LIST.path,
                loadComponent: () =>
            ...
            {
                path: ROUTES.ADMIN.children.PAYMENT.children.CREATE.path,
                data: {
                    title: 'Create',
                },
            ...
            {
                path: ROUTES.ADMIN.children.PAYMENT.children.EDIT.path,
                data: {
                    title: 'Edit',
                },
            ...
            {
                path: ROUTES.ADMIN.children.PAYMENT.children.DETAIL.path,
                data: {
                    title: 'Detail',
                },
