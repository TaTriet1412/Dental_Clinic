...
export class PaymentComponent implements OnInit, OnDestroy {
  ...
  goToCreateBill() {
    this.router.navigate([ROUTES.RECEPTIONIST.children.PAYMENT.children.CREATE.fullPath]);
  }

  goToDetailBill(id: string) {
    this.router.navigate([ROUTES.RECEPTIONIST.children.PAYMENT.children.DETAIL.fullPath(id)]);
  }

  goToEditBill(id: string) {
    this.router.navigate([ROUTES.RECEPTIONIST.children.PAYMENT.children.EDIT.fullPath(id)]);
  }
