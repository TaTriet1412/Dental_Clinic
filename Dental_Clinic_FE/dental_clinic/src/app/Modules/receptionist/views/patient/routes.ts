...
const defaultUrl = ROUTES.RECEPTIONIST.children.PATIENT.children.LIST.path;
...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            {
                path: ROUTES.RECEPTIONIST.children.PATIENT.children.LIST.path,
                loadComponent: () =>
            ...
            {
                path: ROUTES.RECEPTIONIST.children.PATIENT.children.CREATE.path,
                data: {
                    title: 'Create',
                },
            ...
            {
                path: ROUTES.RECEPTIONIST.children.PATIENT.children.EDIT.path,
                data: {
                    title: 'Edit',
                },
            ...
            {
                path: ROUTES.RECEPTIONIST.children.PATIENT.children.DETAIL.path,
                data: {
                    title: 'Detail',
                },
