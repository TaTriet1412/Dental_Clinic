...
export class AppointmentComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.data$ = combineLatest([
        this.apiParams$,
        // Fetch all data once
        this.appointmentService.getAppointmentsByDentistId(this.authService.getUserId()).pipe(
  ...
  goToDetailAppointment(id: string) {
    this.router.navigate([ROUTES.DENTIST.children.SCHEDULE.children.APPOINTMENT.children.DETAIL.fullPath(id)]);
  }
