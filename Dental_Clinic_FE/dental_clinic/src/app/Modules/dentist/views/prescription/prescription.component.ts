...
export class PrescriptionComponent implements OnInit, OnDestroy {
  ...
  goToCreatePrescription() {
    this.router.navigate([ROUTES.DENTIST.children.PRESCRIPTION.children.CREATE.fullPath]);
  }

  goToDetailPrescription(id: string) {
    this.router.navigate([ROUTES.DENTIST.children.PRESCRIPTION.children.DETAIL.fullPath(id)]);
  }

  goToEditPrescription(id: string) {
    this.router.navigate([ROUTES.DENTIST.children.PRESCRIPTION.children.EDIT.fullPath(id)]);
  }
